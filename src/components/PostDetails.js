      ...
      {currentUser ? (  
        <div style={{ marginBottom: 15 }}>  
          ...
          <button  
            ...
            style={{ marginTop: 10, padding: '8px 16px', backgroundColor: '#4caf50', color: 'white', border: 'none', borderRadius: 6, cursor: 'pointer' }}  
          >  
            Post Comment  
          </button>  
        </div>  
        ...
        <p style={{ marginBottom: 10 }}>  
          ...
          <button  
            ...
            style={{ backgroundColor: '#4caf50', color: 'white', border: 'none', borderRadius: 5, padding: '6px 12px', cursor: 'pointer', marginLeft: 10 }}  
          >  
            Login  
          </button>  
        </p>  
