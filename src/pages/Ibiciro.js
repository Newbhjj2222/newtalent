    ...
    <div className={styles.container}>
      ...
      <div className={styles.footer}>
        <p>
          ...
          <br />
          <a href="https://www.newtalentsg.co.rw" target="_blank" rel="noopener noreferrer">
...
const plans = [
  {
    ...
    price: "20 RWF",
    details:
      "Umusomyi yishyura 20 RWF kugira ngo asome igice kimwe cy’inkuru imwe (NeS 1).",
    extra:
  ...
  },
  {
    ...
    price: "100 RWF",
    details:
      "Umusomyi yishyura 100 RWF kugira ngo abone ibice 7 by’inkuru.",
    extra:
      "Igice kimwe gihwanye na 14.3 RWF. Ni uburyo bwo guhendukira abashaka gusoma byinshi.",
  },
  {
    title: "🟢 Umunsi NeS 10 – 150 RWF",
    price: "150 RWF / umunsi",
    details:
      "Umusomyi yishyura 150 RWF ku munsi, agasoma ibice 10 cyangwa munsi yayo mu masaha 24.",
    extra:
  ...
  },
  {
    ...
    details:
      "Umusomyi yishyura 200 RWF ku cyumweru, agasoma ibice 15 mu minsi 7.",
    extra:
      "Igice kimwe gihwanye na 13.3 RWF. Iyo icyumweru kirangiye utazikoresheje zirarangira.",
  },
  {
    title: "🟢 Icyumweru NeS 25 – 300 RWF",
    price: "300 RWF / icyumweru",
    details:
      "Umusomyi yishyura 300 RWF ku cyumweru, agasoma ibice 25.",
    extra:
      "Igice kimwe gihwanye na 12 RWF. Ni nziza ku bakunda gukurikira inkuru nyinshi.",
  },
  {
    title: "🟢 Ukwezi NeS 60 – 600 RWF",
    price: "600 RWF / ukwezi",
    details:
      "Umusomyi yishyura 600 RWF ku kwezi, agasoma ibice 60.",
    extra:
      "Igice kimwe gihwanye na 10 RWF. Ni plan ihendutse cyane ku bakunda gusoma buri munsi.",
  },
  {
    title: "🟢 Ukwezi kose – 1200 RWF",
    price: "1200 RWF / ukwezi",
    details:
      "Umusomyi yishyura 1200 RWF agahabwa uburenganzira busesuye bwo gusoma inkuru zose.",
    extra:
      "Ni “VIP Plan” (All Access). Uko kwezi gushize irahagarara.",
  },
];
